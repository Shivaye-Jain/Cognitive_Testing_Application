            ...
            <dh-component>
                <div class="container flex justify-center mx-auto pt-16">
                    <div>
                        ...
                        <h1 class="xl:text-4xl text-3xl text-center text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">The Talented People Behind the Cog-Sci IIIT-Hyderabad</h1>
                    </div>
                </div>
